...
%           point X(i, :) has been assigned to cluster c.
    ...
    while num_clusters > k
        ...
        [value1 value2]=find(dists==min(dists(:)));
        j=value2(1);
        i=value1(1);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %                                                                     %
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %finding mean index
        index_mean=[find(i==idx) find(j==idx)];
        % created temporary centroid and assign mean of X
        temp_centroid=mean(X(index_mean,:),1);
        % assign temporary centroid value to centroid 
        centroids(i,:)=temp_centroid;centroids(j,:)=Inf;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %                                                                     %
        %                            END YOUR CODE                            %
        %                                                                     %
        ...
        %                                                                     %
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %adding cluster size of i and j and assign it to cluster i
